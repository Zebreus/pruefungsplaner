...
protected:
    /** Reads all strings, numbers and booleans from QJsonObject into this metaobject
     *
     * @param  content the QJsonObject containing key value pairs for every string, number and boolean property of this QMetaObject
     */
     ...
     *
     * @param  content a QJsonArray containing number QJsonObjects containing the properties of the objects
     * @return
     */
    template<class T>
     ...
     *
     * @param  content a QJsonArray containing number QJsonValues containing the ids of the objects to refer to
     * @param  objects a QList of SerializableDataObjectss
     * @return
     */
    template<class T>
    QList<T*> fromIdJsonArray(const QJsonArray& content, const QList<T*>& objects);
    template<class T>
    QList<T*> fromIdJsonArray(const QJsonValue& content, const QList<T*>& objects);
...
template<class T>
QList<T *> SerializableDataObject::fromObjectJsonArray(const QJsonArray &content)
{
    QList<T*> resultList;
...
template<class T>
QList<T*> SerializableDataObject::fromObjectJsonArray(const QJsonValue& content){
    return fromObjectJsonArray<T>(content.toArray());
}

template<class T>
QList<T *> SerializableDataObject::fromIdJsonArray(const QJsonArray &content, const QList<T *> &objects)
{
    QList<T*> resultList;
...
template<class T>
QList<T *> SerializableDataObject::fromIdJsonArray(const QJsonValue &content, const QList<T *> &objects)
{
